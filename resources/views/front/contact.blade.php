...
@section('main')
                        ...
                        <ul class="row">
                            ...
                            <li class="col-sm-6">
                                <address>
                                    ...
                                    <p>Tel. Móvil : 55 - 1963 - 4388 <br>
                                    Email : g-gloria-c@live.com.mx</p>
                                </address>
                                
                                <address>
                                    <h2>ING. LEONARDO BALDERAS LÓPEZ    </h2>
                                    <h5>GERENTE INGENIERÍA</h5>
                                    <p>Tel. Móvil : 55 - 3702 - 4799 <br>
                                    Email : lbalderasl@live.com.mx</p>
                                </address>
                            </li>
                            <li class="col-sm-6" >
                                <address>  
                                    <h2>Dirección:</h2>
                                    <p>Calle Tonatico No. 287<br>
                                        Colonia Las Fuentes<br> Municipio Nezahualcóyotl<br>
                                    Estado de México C.P. 57600</p>
                                    <p>Telefono : (55) 36 - 89 - 41 - 70 <br>
                                        Email : gc_ingenieria-aire@yahoo.com.mx
                                    </p>
                                </address>
                            </li>
                        </ul>
    ...
    <section id="contact-page">
        <div class="container">
            <div class="center">        
                <h2>Mándamos un mensaje</h2>
                <p class="lead">En breve te responderemos</p>
            </div> 
